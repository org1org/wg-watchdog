...
> Рабочая ветка рефакторинга: полноэкранный интерфейс и согласование удаления
> с работающими заданиями ещё не выпущены как стабильный релиз.
> Установочная ссылка ниже по-прежнему устанавливает main.
...
В каталоге `tests` находится стенд с подменёнными системными командами. Он выполняет 55 проверок:
