...
В каталоге `tests` находится стенд с подменёнными системными командами. Он выполняет 38 проверок: основные ветви восстановления, диалоги менеджера, оба варианта меню, установку, повторный запуск, `--force` и полное удаление без доступа к роутеру:
