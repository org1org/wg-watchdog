...
Установленная программа занимает около 55 КБ без учёта конфигураций. Компактный установщик и тестовый стенд на роутере не сохраняются.
...
В каталоге `tests` находится стенд с подменёнными системными командами. Он выполняет 45 проверок: ветви восстановления, диалоги менеджера, установку, повторный запуск, `--force`, удаление, сохранность чужих строк cron, изоляцию параметров заданий, временные файлы и остановку между down/up:
